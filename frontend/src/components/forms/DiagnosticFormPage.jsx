...
const DiagnosticFormPage = () => {
  ...
  // additional check: form version
  if (form && (!form.version || form.version <= 0)) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-8 max-w-md text-center">
          <h2 className="text-2xl font-bold text-yellow-700 mb-4">Biểu mẫu không hợp lệ</h2>
          <p className="text-yellow-600 mb-6">Biểu mẫu này chưa có phiên bản nào để thực hiện, vui lòng chọn biểu mẫu khác hoặc tạo phiên bản trước.</p>
          <button
            onClick={() => navigate(-1)}
